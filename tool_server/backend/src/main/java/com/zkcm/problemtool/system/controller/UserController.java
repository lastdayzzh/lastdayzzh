...
import com.zkcm.problemtool.common.utils.MD5Util;
import com.zkcm.problemtool.system.domain.Role;
import com.zkcm.problemtool.system.domain.User;
import com.zkcm.problemtool.system.domain.UserConfig;
import com.zkcm.problemtool.system.service.RoleService;
import com.zkcm.problemtool.system.service.UserConfigService;
...
public class UserController extends BaseController {
    ...
    public void addUser(@Valid User user) throws ProblemToolException {
        try {
    ...
    public void updateUser(@Valid User user) throws ProblemToolException {
        try {
    ...
    public void deleteUsers(@NotBlank(message = "{required}") @PathVariable String userIds) throws ProblemToolException {
        try {
    ...
    @PutMapping("profile")
    public void updateProfile(@Valid User user) throws ProblemToolException {
        try {
    ...
    public void updateAvatar(
            ...
            @NotBlank(message = "{required}") String avatar) throws ProblemToolException {
        try {
    ...
    public void updateUserConfig(@Valid UserConfig userConfig) throws ProblemToolException {
        try {
    ...
    public void updatePassword(
            @NotBlank(message = "{required}") String username,
            @NotBlank(message = "{required}") String password) throws ProblemToolException {
        try {
    ...
    public void resetPassword(@NotBlank(message = "{required}") String usernames) throws ProblemToolException {
        try {
    ...
    public void export(QueryRequest queryRequest, User user, HttpServletResponse response) throws ProblemToolException {
        try {
