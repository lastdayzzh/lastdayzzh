...
import com.zkcm.problemtool.system.domain.RoleMenu;
import com.zkcm.problemtool.system.service.RoleMenuServie;
...
public class RoleController extends BaseController {
    ...
    public void addRole(@Valid Role role) throws ProblemToolException {
        try {
    ...
    public void deleteRoles(@NotBlank(message = "{required}") @PathVariable String roleIds) throws ProblemToolException {
        try {
    ...
    public void updateRole(Role role) throws ProblemToolException {
        try {
    ...
    public void export(QueryRequest queryRequest, Role role, HttpServletResponse response) throws ProblemToolException {
        try {
