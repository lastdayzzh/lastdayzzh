...
import com.zkcm.problemtool.system.domain.SysLog;
import com.zkcm.problemtool.system.service.LogService;
...
public class LogController extends BaseController {
    ...
    public void deleteLogss(@NotBlank(message = "{required}") @PathVariable String ids) throws ProblemToolException {
        try {
    ...
    public void export(QueryRequest request, SysLog sysLog, HttpServletResponse response) throws ProblemToolException {
        try {
