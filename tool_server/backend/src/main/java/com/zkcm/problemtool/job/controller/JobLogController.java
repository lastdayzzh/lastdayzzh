...
import com.zkcm.problemtool.job.service.JobLogService;
...
public class JobLogController extends BaseController {
    ...
    public void deleteJobLog(@NotBlank(message = "{required}") @PathVariable String jobIds) throws ProblemToolException {
        try {
    ...
    public void export(QueryRequest request, JobLog jobLog, HttpServletResponse response) throws ProblemToolException {
        try {
