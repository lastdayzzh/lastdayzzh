...
import com.zkcm.problemtool.common.annotation.Limit;
import com.zkcm.problemtool.common.authentication.JWTToken;
import com.zkcm.problemtool.common.authentication.JWTUtil;
import com.zkcm.problemtool.common.domain.ActiveUser;
...
import com.zkcm.problemtool.common.properties.FebsProperties;
import com.zkcm.problemtool.common.service.RedisService;
import com.zkcm.problemtool.common.utils.*;
...
public class LoginController {
    ...
    public FebsResponse login(
        ...
        if (user == null)
            throw new ProblemToolException(errorMessage);
        if (!StringUtils.equals(user.getPassword(), password))
            throw new ProblemToolException(errorMessage);
        if (User.STATUS_LOCK.equals(user.getStatus()))
            throw new ProblemToolException("账号已被锁定,请联系管理员！");
