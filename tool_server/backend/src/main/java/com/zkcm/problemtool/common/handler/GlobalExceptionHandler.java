package com.zkcm.problemtool.common.handler;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(value = ProblemToolException.class)
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    public FebsResponse handleParamsInvalidException(ProblemToolException e) {
