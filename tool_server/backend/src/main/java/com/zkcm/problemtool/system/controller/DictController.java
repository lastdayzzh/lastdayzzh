...
import com.zkcm.problemtool.system.domain.Dict;
import com.zkcm.problemtool.system.service.DictService;
...
public class DictController extends BaseController {
    ...
    public void addDict(@Valid Dict dict) throws ProblemToolException {
        try {
    ...
    public void deleteDicts(@NotBlank(message = "{required}") @PathVariable String dictIds) throws ProblemToolException {
        try {
    ...
    public void updateDict(@Valid Dict dict) throws ProblemToolException {
        try {
    ...
    public void export(QueryRequest request, Dict dict, HttpServletResponse response) throws ProblemToolException {
        try {
